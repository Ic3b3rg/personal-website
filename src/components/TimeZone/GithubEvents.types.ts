export interface GithubEventBase {
  ...
  export type GithubEvent =
    | (GithubEventBase & { type: "CommitCommentEvent"; payload: CommitCommentPayload })
    ...
    | (GithubEventBase & { type: "IssueCommentEvent"; payload: IssueCommentEventPayload })
    ...
    | (GithubEventBase & { type: "PullRequestReviewEvent"; payload: PullRequestReviewEventPayload })
    | (GithubEventBase & { type: "PullRequestReviewCommentEvent"; payload: PullRequestReviewCommentEventPayload })
    | (GithubEventBase & { type: "PullRequestReviewThreadEvent"; payload: PullRequestReviewThreadEventPayload })
    | (GithubEventBase & { type: "PushEvent"; payload: PushEventPayload })
    | (GithubEventBase & { type: "ReleaseEvent"; payload: ReleaseEventPayload })
    | (GithubEventBase & { type: "SponsorshipEvent"; payload: SponsorshipEventPayload })
